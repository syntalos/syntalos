...
GstCaps *CapsWidget::get_caps() const
{
    ...
    gst_util_double_to_fraction(framerate, &num, &denom);
...
void CapsWidget::setup_ui()
{
    ...
    if (m_caps.has_binning()) {
        ...
        connect(p_combo_binning, &QComboBox::currentTextChanged, this, &CapsWidget::combo_binning_changed);
    }
    ...
    if (m_caps.has_skipping()) {
        ...
        connect(p_combo_skipping, &QComboBox::currentTextChanged, this, &CapsWidget::combo_skipping_changed);
    }
    ...
    connect(p_combo_resolution, &QComboBox::currentTextChanged, this, &CapsWidget::combo_res_changed);
    ...
    connect(p_combo_framerate, &QComboBox::currentTextChanged, this, &CapsWidget::combo_fps_changed);
...
void CapsWidget::combo_res_changed(const QString &new_value)
{
    ...
    fill_combo_framerate(p_combo_format->currentText(), get_scaling(), entries.at(0).toInt(), entries.at(1).toInt());
}
