...
#if defined(_BOARD_MUXSHIELD2)
#define TOTAL_ANALOG_PINS       0
#define TOTAL_PINS              48 // All pins can be digital
#define MAX_SERVOS              0
#define VERSION_BLINK_PIN       PIN_LED1
#define IS_PIN_DIGITAL(p)       ((p) >= 0)
#define IS_PIN_ANALOG(p)        (0)  // FIXME: Implement analog support
