...
private:
    RangeSliderPrivate& operator=(const RangeSliderPrivate&);
};
...
// --------------------------------------------------------------------------
RangeSliderPrivate::Handle RangeSliderPrivate::handleAtPos(
...
RangeSlider::RangeSlider(
        RangeSliderPrivate* impl, Qt::Orientation o, QWidget* parentObject)
    : QSlider(o, parentObject)
    , d_ptr(impl)
{
    Q_D(RangeSlider);
...
// --------------------------------------------------------------------------
void RangeSlider::mouseDoubleClickEvent(QMouseEvent* mouseEvent)
{
    Q_D(RangeSlider);
