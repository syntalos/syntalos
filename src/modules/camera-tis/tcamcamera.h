...
public:
    ...
    virtual bool get(TcamCamera &, int&) { return false; }
    virtual bool get(TcamCamera &, double&) { return false; }
    virtual bool get(TcamCamera &, std::string&) { return false; }
    virtual bool set(TcamCamera &, int)  { return false; }
    virtual bool set(TcamCamera &, double) { return false; }
    virtual bool set(TcamCamera &, std::string) { return false; }
};
...
class TcamCamera
{
    public:
        ...
        */
        ...
        GstElement* getCaptureSink() { return capturesink_; };
