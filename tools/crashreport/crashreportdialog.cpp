      ...
      m_mode(mode)
{
    ...
    if (m_mode == ReportMode::DEBUG_FREEZE) {
        ...
        ui->introLabel->setText(QStringLiteral("<html><p>This tool try to gather useful information about a <b>currently running</b> "
                                               "but currently frozen <i>Syntalos</i> instance.</p>"
