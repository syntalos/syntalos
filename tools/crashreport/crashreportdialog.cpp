      ...
      m_mode(mode)
{
    ...
    if (m_mode == ReportMode::DEBUG_FREEZE) {
        ...
        ui->introLabel->setText(QStringLiteral(
            "<html><p>This tool will try to collect useful information about a <b>currently running</b> "
...
void CrashReportDialog::on_nextButton_clicked()
{
    ...
    if (currentPage == ui->pageResult) {
        ...
        QString fileName;
        QString fnameSuggestion = QStringLiteral("%1_%2.md")
                                      .arg(baseNamePrefix, QDateTime::currentDateTime().toString("yyddMM"));
